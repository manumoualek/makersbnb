...
describe Request do
  describe "#create" do
    it "should add a request to the database" do
      ...
      connection.exec("INSERT INTO users (username, password, first_name, second_name, email) values ('testguest1', 'testguest1', 'testguest1', 'testguest1', 'testguest1@email.com');")
