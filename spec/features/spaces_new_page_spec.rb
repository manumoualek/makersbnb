feature "List a space page" do
  ...
  spaces, should see their own space that they just made" do
    ...
    fill_in('userID', with: '1') #UserID param must be present for a new space to be created. Here we need to fake the UserID, which must match the UserID in the table (autogenerated in the setup_test_database)
    click_button('List my space')
    

    ###These are unit tests, not feature test
